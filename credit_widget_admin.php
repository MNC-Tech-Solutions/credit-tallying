...
// Overview: aggregate totals only — no individual rows loaded into memory
...
// Per-location detail: fetched via AJAX only when a location is selected
...
// AJAX endpoint: monthly detail for one location
